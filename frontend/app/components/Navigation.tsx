...
const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <>
      ...
      <div className={`md:hidden fixed top-0 ring-[1px] ring-white left-0 h-full w-[280px] bg-white shadow-lg z-[101] transform transition-transform duration-300 ${isMobileCategoriesOpen ? 'translate-x-0' : '-translate-x-full'
        }`} data-mobile-sidebar>
      ...
      <div className="flex flex-col justify-center fixed top-0 z-[100] w-full items-center">
        <nav className="bg-white w-[95vw] max-w-[1400px] drop-shadow-md ring-gray-600 ring-[0.5px] mt-[5px] rounded-[10px] ">
          ...
          <div className="flex px-3 md:px-[30px] rounded-[10px] sm:rounded-b-[0px]  sm:rounded-t-[10px] text-white bg-[#0A0A0A] justify-between items-center h-[60px] md:h-[80px]">
            ...
            <div className="hidden md:flex flex-row ml-[10px] w-full mx-[30px]">
              ...
              <button
                ...
                className="bg-gradient-to-r from-emerald-600 to-teal-600 flex items-center justify-center cursor-pointer h-[45px] w-[45px] rounded-r-[5px] hover:from-emerald-700 hover:to-teal-700 transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                aria-label="Search"
                disabled={!query.trim()}
              >
            ...
            <div className="flex items-center space-x-1 md:space-x-4">
              ...
              {!userLoggedIn ? (
                <div className="hidden sm:flex flex-col items-center justify-center leading-[20px]">
                  ...
                  <button
                    className="bg-gradient-to-r from-emerald-600 to-teal-600 cursor-pointer text-white px-[14px] py-[3px] text-[13px] rounded-[4px] flex items-center justify-center hover:from-emerald-700 hover:to-teal-700 transition-all font-medium"
              ...
              {!userLoggedIn && (
                <button
                  className="sm:hidden bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-3 py-1.5 rounded-full text-xs font-medium hover:from-emerald-700 hover:to-teal-700 transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                  onClick={handleNavLoginClick}
                >
                  Login
                </button>
              ...
              >
                <button
                  className="cursor-pointer relative focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 rounded-full p-1"
                  onClick={() => {
                    if (!userLoggedIn) {
                      router.push("/login");
                    } else {
                  ...
                  <div className="w-[300px] lg:w-[400px] bg-[#F5F5F5] p-[10px] absolute right-0 lg:right-[2%] top-[55px] md:top-[60px] drop-shadow-lg rounded-[10px] ring-gray-800 ring-[0.5px] z-[110] hidden md:block">
                    ...
                    {userLoggedIn && cart && cart.products && cart.products.length > 0 && (
                      <button
                        ...
                        className="text-white bg-gradient-to-r from-emerald-600 to-teal-600 w-full py-[8px] flex items-center justify-center rounded-[5px] cursor-pointer mt-[8px] hover:from-emerald-700 hover:to-teal-700 transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 font-medium"
                      >
                        View All Products
                      </button>
                    )}
          ...
          {/* Mobile Search Bar */}
          <div className={`md:hidden bg-white transition-all duration-300 overflow-hidden ${isMobileSearchOpen ? 'max-h-[120px] border-t border-gray-200' : 'max-h-0'
            }`}>
          ...
          <div className="hidden md:flex rounded-b-[9px] flex-row items-center px-[20px] text-[14.5px] text-white bg-gradient-to-r from-emerald-700 to-teal-700 space-x-[20px] w-full h-[40px]">
            <button
          ...
          {/* Mobile Menu */}
          <div className={`md:hidden bg-white transition-all duration-300 overflow-hidden ${isMobileMenuOpen ? 'max-h-[400px] border-t border-gray-200' : 'max-h-0'
            }`}>
