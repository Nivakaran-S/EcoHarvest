...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b w-full overflow-x-hidden from-gray-900 to-gray-950 text-white relative overflow-hidden">
      {/* Decorative background */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 left-10 w-48 h-48 border border-emerald-500 rounded-full" />
        <div className="absolute bottom-10 right-10 w-64 h-64 border border-teal-500 rounded-full" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              <Image alt="EcoHarvest" width={200} src={EcoHarvest} />
            </div>
            ...
            {/* Newsletter Signup */}
            <div className="mb-6">
              <h4 className="text-sm font-bold text-white mb-3">Stay Updated</h4>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-l-xl text-sm focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all placeholder-gray-500"
                />
                <button className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 rounded-r-xl transition-all">
          ...
          <div className="lg:ml-8">
            <h3 className="text-lg font-bold mb-6 text-white relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-8 h-0.5 bg-gradient-to-r from-emerald-500 to-teal-500" />
            </h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  ...
                  >
                    <svg className="w-4 h-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center text-sm text-gray-400">
                <div className="w-10 h-10 bg-emerald-900/50 rounded-xl flex items-center justify-center mr-3 flex-shrink-0">
                  <svg className="w-5 h-5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <a href="mailto:support@ecoharvest.lk" className="hover:text-emerald-400 transition-colors">
              ...
              <div className="flex space-x-3">
                {[
                  ...
                  <a
                    key={index}
                    href={social.href}
                    className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-teal-600 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                    target="_blank"
