      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-72">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-1">Here's your business performance at a glance</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-6">
            <div className="p-5 sm:p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <h3 className="text-gray-500 text-sm font-medium mb-2">Pending Orders</h3>
              <p className="text-3xl sm:text-4xl font-bold text-orange-500">{vendorStats.pendingOrders}</p>
            ...
            <div className="p-5 sm:p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-green-500">{vendorStats.completedOrders}</p>
            ...
            <div className="p-5 sm:p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-3xl sm:text-4xl font-bold text-blue-500">
                ...
                {vendorStats.averageRating > 0 && <span className="text-base text-gray-400">/5</span>}
              </p>
          ...
          {notifications.length > 0 && (
            <div className="mt-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-6 max-h-96 overflow-y-auto">
                <div className="divide-y divide-gray-100">
                  {notifications.slice(0, 5).map((notification) => (
                    <div key={notification._id} className="py-4 first:pt-0 last:pb-0">
